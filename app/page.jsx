...
import { features } from "@/data/features"; // Assuming you have a features.js file with feature data
import { howItWorks } from "@/data/howItWorks";
import { testimonial } from "@/data/testimonial";
import { faqs } from "@/data/faq";
import { Accordion, AccordionItem, AccordionTrigger, AccordionContent } from "@/components/ui/accordion";
import { Arrow } from "@radix-ui/react-dropdown-menu";
import { AArrowDownIcon, ArrowRightIcon } from "lucide-react";
...
export default function Home() {
  return (
    <div>
      ...
      <section className="w-full py-12 md:py-24 bg-background/40">
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            <div className="flex flex-col items-center justify-center space-y-2">
              ...
              <p className="text-muted-foreground">Insustries Covered</p>
            </div>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-muted-foreground">Four simple steps to accelerate your carer growth</p>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-background/40">
                      ...
                      <div className="flex items-center spacex-6">
                        <div className="relative h-12 w-12 flex-shrink-0">
                          <Image
                            ...
                            width={40}
                            height={40}
                            className="rounded-full  objext-cover border-2 border-primary/20" />
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-muted-foreground">Find answers to common questions aout our platform</p>
      ...
      <section className="w-full ">
        ...
        <div className="mx-auto py-24 bg-shiny-white rounded-lg">
